...
namespace TechXpress.Data.Migrations
{
    ...
    [Migration("20250502201339_Complete-Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechXpress.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TechXpress.Domain.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TechXpress.Domain.Entities.Order", b =>
                {
                    b.HasOne("TechXpress.Domain.Entities.ApplicationUser", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("TechXpress.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("TechXpress.Domain.Entities.ApplicationUser", "Seller")
                        .WithMany("Products")
